...
const AddSpecialty = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
            ...
            ? {
                ...
                specialties: isEditing
                  ? country.specialties.map((s) =>
                      s === selectedSpecialty.specialty ? specialty : s
                    )
      ...
      Swal.fire({
        icon: "success",
        title: isEditing ? "Specialty Updated!" : "Specialty Added!",
        text: `The specialty has been successfully ${
      ...
      Swal.fire({
        ...
        } the specialty. Please try again.`,
        confirmButtonColor: "#3B82F6",
      });
    } finally {
      setLoading(false);
