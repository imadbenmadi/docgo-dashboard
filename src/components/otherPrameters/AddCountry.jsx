...
const AddCountry = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = isEditing ? `/countries/${selectedCountry.id}` : "/countries";
      ...
      Swal.fire({
        icon: "success",
        title: isEditing ? "Pays mis à jour !" : "Pays ajouté !",
        text: `Le pays a été ${isEditing ? "mis à jour" : "ajouté"} avec succès.`,
      ...
      Swal.fire({
        ...
        text: `Une erreur s'est produite lors de ${isEditing ? "la mise à jour" : "l'ajout"} du pays. Veuillez réessayer.`,
        confirmButtonColor: "#3B82F6",
      });
    } finally {
      setLoading(false);
