...
const SearchAndFilters = ({
  ...
  totalPrograms,
  onReset,
  programs = [], // Add programs prop to get categories and universities
}) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  onChange={(e) =>
                    handleLocalFilterChange("programType", e.target.value)
                  }
                  className="w-full p-3 border border-gray-200 rounded-lg appearance-none bg-white focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleLocalFilterChange("minScholarship", e.target.value)
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleLocalFilterChange("maxScholarship", e.target.value)
                }
                className="w-full p-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
            </div>
