        ...
        <div className="p-8 max-h-[calc(90vh-16rem)] overflow-y-auto">
          ...
          <div className="flex items-start justify-between mb-6">
            <div className="flex-1">
              ...
              {program.title_ar && (
                <h1 className="text-2xl font-bold text-gray-600 mb-2" dir="rtl">
                  {program.title_ar}
                </h1>
              )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            {program.programStartDate && program.programEndDate && (
              <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                  <p className="text-sm text-gray-600">Durée du programme</p>
                  <p className="font-semibold text-gray-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6 border-t border-gray-200">
            <div>
              <p className="text-sm text-gray-600">Type de programme</p>
            ...
            <div>
              <p className="text-sm text-gray-600">ID du programme</p>
