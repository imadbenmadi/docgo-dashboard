        ...
        <div className="p-6 max-w-5xl mx-auto">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-500 text-sm ml-12">
                    Générez et téléchargez des QR codes personnalisés pour vos réseaux sociaux
                </p>
            </div>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                            ...
                            {PRESETS.map((preset) => (
                                ...
                                >
                                    <span
                                        ...
                                        style={{ backgroundColor: preset.fg, borderColor: preset.fg + "44" }}
                                    />
                                    {preset.label}
                                </button>
                            ))}
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <label className="block">
                                <span className="text-xs text-gray-500 mb-1.5 block">Couleur QR</span>
                                <div className="flex items-center gap-2 border border-gray-200 rounded-lg px-3 py-2 cursor-pointer hover:border-gray-300 transition-colors">
                                    ...
                                    />
                                    <span className="text-sm font-mono text-gray-700 flex-1">{fgColor}</span>
                                    <input
                                        type="color"
                                        value={fgColor}
                                        ...
                                        id="fg-color"
                                    />
                                    <label htmlFor="fg-color" className="cursor-pointer text-xs text-blue-600 hover:underline shrink-0">
                                        Changer
                                    </label>
                                </div>
                            </label>
                            <label className="block">
                                ...
                                <div className="flex items-center gap-2 border border-gray-200 rounded-lg px-3 py-2 cursor-pointer hover:border-gray-300 transition-colors">
                                    ...
                                    />
                                    <span className="text-sm font-mono text-gray-700 flex-1">{bgColor}</span>
                                    <input
                                        type="color"
                                        value={bgColor}
                                        ...
                                        id="bg-color"
                                    />
                                    <label htmlFor="bg-color" className="cursor-pointer text-xs text-blue-600 hover:underline shrink-0">
                                        Changer
                                    </label>
                                </div>
                            </label>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <div className="flex justify-between mb-1.5">
                                    <span className="text-xs text-gray-600 font-medium">Taille</span>
                                    <span className="text-xs text-blue-600 font-semibold">{size}px</span>
                                </div>
                                <input
                                    type="range"
                                    min={128}
                            ...
                            <div>
                                <div className="flex justify-between mb-1.5">
                                    ...
                                    <span className="text-xs text-blue-600 font-semibold">{margin}</span>
                                </div>
                                <input
                                    type="range"
                                    min={0}
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-xl px-4 py-3">
                        <p className="text-xs text-blue-700 leading-relaxed">
                            <span className="font-semibold">Conseil :</span> Pour un usage sur les réseaux sociaux,
                            utilisez la correction d'erreur <span className="font-semibold">H</span> (30%) pour que
                            le QR code reste lisible même si une partie est masquée par un logo.
                        </p>
                    </div>
                </div>
            </div>
