...
const CourseApplications = () => {
    ...
    const handleApprove = async (app) => {
        ...
        setProcessing(true);
        const res = await ApplicationsAPI.updateCourseApplicationStatus(
            app.id,
            {
                status: "approved",
    ...
    const handleRejectPaidPayment = async (app) => {
        ...
        setProcessing(true);
        const res = await ApplicationsAPI.rejectCoursePayment(
            payment.id,
            reason,
        );
        setProcessing(false);
            ...
            <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">
                        Candidatures aux Cours
                    </h1>
                    <p className="text-sm text-gray-500 mt-1">
                        Gérez les inscriptions gratuites et les paiements CCP
                        des cours
                    </p>
                </div>
                <button
