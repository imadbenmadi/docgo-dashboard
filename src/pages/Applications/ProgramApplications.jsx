...
const ProgramApplications = () => {
  ...
  const handleRejectPaidPayment = async (app) => {
    ...
    setProcessing(true);
    const res = await ApplicationsAPI.rejectProgramPayment(payment.id, reason);
    setProcessing(false);
      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Manage free and paid program applications
          </p>
        </div>
        <button
          onClick={() => {
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <p className="font-medium text-gray-900 max-w-[160px] truncate">
                          {app.Program?.title || `Programme #${app.ProgramId}`}
                        </p>
                        <p className="text-xs text-gray-500">
                ...
                <div className="flex gap-3 mt-5">
                  <button
                    onClick={() => {
                      ...
                      selectedApplication.paymentType === "free"
                        ? handleApproveFree(selectedApplication)
