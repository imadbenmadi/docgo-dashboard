...
const FRONTEND_URL =
  ...
  "https://dashboard.healthpathglobal.com/";
    ...
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Modifiez le contenu, les sections et les éléments en vedette
          </p>
        </div>
        <a
          href={FRONTEND_URL}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        >
          ...
          <p className="font-semibold text-gray-900">Éditeur de contenu</p>
        ...
        >
          ...
          <p className="font-semibold text-gray-900">Éléments en vedette</p>
          <p className="text-xs text-gray-500 mt-1">
      ...
      <section className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b bg-gray-50">
          ...
          <p className="text-xs text-gray-400 mt-0.5">
            Activez ou désactivez chaque section de la page d&apos;accueil
          </p>
        </div>

        <div className="divide-y divide-gray-50">
          {sectionMeta.map(({ key, label, icon: Icon, color, desc, link }) => {
