    ...
    return (
        <div>
            <div className="bg-blue-50 border border-blue-100 rounded-xl px-4 py-3 mb-5 text-xs text-blue-700">
                ...
                version EN ou FR.{subtitle ? ` ${subtitle}` : ""}
                {relatedItems && relatedItems.length > 0 && (
                    <span>
                        {" "}
                        Cochez les spécialités disponibles pour chaque
                        destination.
                    </span>
                )}
            </div>
                        ...
                        {relatedItems && relatedItems.length > 0 && (
                            <div className="px-4 pb-4 border-t border-gray-50 pt-3">
                                <p className="text-[10px] font-semibold text-gray-500 mb-2 flex items-center gap-1">
                                    ...
                                    Spécialités disponibles dans cette
                                    destination
                                    <span className="ml-1 font-normal text-gray-400">
                                        (laissez tout décoché = visible pour
...
const FilterOptions = () => {
    ...
    useEffect(() => {
        (async () => {
            ...
            if (res.success) {
                ...
                setFields(toList(res.content.filterStudyFields));
    ...
    const handleSave = async (type) => {
        ...
        const key =
            type === "fields" ? "filterStudyFields" : "filterStudyLocations";
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400">
                            Gérez les options des filtres affichés sur la page
                            d&apos;accueil
                        </p>
                    </div>
                </div>
