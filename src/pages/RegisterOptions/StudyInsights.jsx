      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        {topCountry && (
          <div className="bg-white/10 rounded-lg p-4">
            ...
            <p className="font-bold text-base">{topCountry.value}</p>
            <p className="text-xs text-white/70 mt-1">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Ce que vos utilisateurs veulent étudier — données extraites des
              inscriptions
            </p>
          </div>
        </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <ResponsiveContainer width="100%" height={250}>
                <LineChart data={monthly}>
                  ...
                  <Tooltip
                    formatter={(v) => [`${v} inscriptions`, "Inscrits"]}
                  />
                  <Legend />
                  <Line
                    type="monotone"
          ...
          {!topFields.length && !topDomains.length && !topCountries.length && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center text-gray-400">
              ...
              <p className="text-sm mt-1">
                Les insights apparaîtront au fur et à mesure que les
                utilisateurs s&apos;inscriront.
              </p>
            </div>
          )}
        </>
