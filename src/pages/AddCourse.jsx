                                ...
                                correctAnswers: Yup.array().when("type", {
                                    ...
                                    then: (schema) =>
                                        schema
                                            ...
                                            .required(
                                                "Les réponses correctes sont requises",
                                            ),
                                    otherwise: (schema) => schema.notRequired(),
                                }),
                            }),
                        ...
                        try {
                            ...
                            if (
                                ...
                                sections.push({
                                    ...
                                    description_ar:
                                        "مقاطع الفيديو والمستندات الخاصة بالدورة",
                                    order: 1,
                                    items: items,
                                });
                            ...
                            if (values.videos && values.videos.length > 0) {
                                console.log(
                                    `📹 Adding ${values.videos.length} video files`,
                                );
                                values.videos.forEach((video, index) => {
                                    if (video.file) {
                            ...
                            if (values.pdfs && values.pdfs.length > 0) {
                                console.log(
                                    `📄 Adding ${values.pdfs.length} PDF files`,
                                );
                                values.pdfs.forEach((pdf, index) => {
                                    if (pdf.file) {
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-8 text-center">
                    ...
                    <p className="text-lg max-md:text-sm  text-gray-600 max-w-2xl mx-auto">
                        ...
                        créant un cours professionnel et engageant
                    </p>
                </div>
