...
const DeleteAccountRequests = () => {
    ...
    const handleApprove = async (request) => {
        ...
        const coursesCount =
            request.userSnapshot?.courseEnrollments?.length || 0;
        const programsCount =
            request.userSnapshot?.programEnrollments?.length || 0;
        ...
        <div className="p-6 max-w-7xl mx-auto">
            ...
            <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 ml-11">
                    Examinez les données de l&apos;utilisateur, les inscriptions
                    et les paiements avant d&apos;approuver.
                </p>
            </div>
            ...
            <div className="mb-5 rounded-xl bg-amber-50 border border-amber-200 p-4 flex items-start gap-3">
                ...
                <div className="text-sm text-amber-800">
                    <strong>Important :</strong> L&apos;approbation anonymise le
                    compte (nom, email, mot de passe effacés) et suspend toutes
                    les inscriptions. Les enregistrements de paiement sont
                    conservés sous l&apos;ID utilisateur anonymisé pour la
                    conformité légale.
                </div>
            </div>
